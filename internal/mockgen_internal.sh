...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/boisjacques/qed/internalpackage
...
cp -r $GOPATH/src/github.com/boisjacques/qed/internal/* $TEMP_DIR/src/github.com/boisjacques/qed/internalpackage
